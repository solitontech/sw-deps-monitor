...
def main():
    ...
    try:
        ...
        body = "This PR was auto-generated by the 'Dependencies Check For All Libraries' workflow.\nIt contains updates to the `ActualDepsList.hawkeyelist` file based on the latest dependency scan."
...
if __name__ == "__main__":
    ...
    # 2. Manually change the deps file (e.g., Hawkeye/ActualDependencies/ActualDepsList.hawkeyelist)
